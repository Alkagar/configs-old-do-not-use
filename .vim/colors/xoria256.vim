...
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=none guifg=#d0d0d0 ctermbg=none guibg=#1c1c1c cterm=none gui=none
hi Cursor                                 ctermbg=214 guibg=#ffaf00
hi CursorColumn                           ctermbg=238 guibg=#444444
hi CursorLine                             ctermbg=237 guibg=#3a3a3a cterm=none gui=none
hi Error        ctermfg=15  guifg=#ffffff ctermbg=1   guibg=#800000
hi ErrorMsg     ctermfg=15  guifg=#ffffff ctermbg=1   guibg=#800000
hi FoldColumn   ctermfg=247 guifg=#9e9e9e ctermbg=none guibg=#121212
hi Folded       ctermfg=255 guifg=#eeeeee ctermbg=none  guibg=#5f5f87
...
hi TabLine      ctermfg=none  guifg=none      ctermbg=242 guibg=#666666 cterm=none gui=none
